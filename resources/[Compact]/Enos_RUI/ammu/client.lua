...
ConfAmmu = {
    ...
    Type = {
		...
		Blanche = {
			{Label = 'Couteau', Value = 'WEAPON_KNIFE', Price = 1000},
			{Label = 'Lampe Torche', Value = 'WEAPON_FLASHLIGHT', Price = 1500},
			{Label = 'Batte de baseball', Value = 'WEAPON_BAT', Price = 2500},
			{Label = 'Poing américain', Value = 'WEAPON_KNUCKLE', Price = 3000}
		},

		Armes = {
			{Label = 'Pistolet Pétoire', Value = 'WEAPON_SNSPISTOL', Price = 15000},
...
Citizen.CreateThread(function()
    while true do
        ...
        RageUI.IsVisible(RMenu:Get('enos_ammu', 'aces'), true, true, true, function()
			...
			RageUI.ButtonWithStyle("Chargeur", nil, {RightLabel = "~g~850$"},true, function(Hovered, Active, Selected)
				if (Selected) then   
					local item = "clip"
					local prix = 850
