...
AddEventHandler('jejey:blanchiement', function(argent)
	...
	local taxe = 0.75    -- Le blanchisseur prend 35% (1-0.65 = 0.35)
	...
	if argent > 0 and xPlayer.getAccount('black_money').money >= argent then
		...
		TriggerClientEvent('esx:showAdvancedNotification', xPlayer.source, 'Information', 'Blanchiement', 'Attend ~r~5 secondes', 'CHAR_MP_FM_CONTACT', 8)
		Citizen.Wait(5000)
