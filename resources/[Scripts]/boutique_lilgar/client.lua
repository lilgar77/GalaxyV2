...
RMenu.Add('boutique', 'main', RageUI.CreateMenu("Boutique GALAXY V2", "Boutique by LILGAR" ))
RMenu.Add('boutique', 'vehiclemenu', RageUI.CreateSubMenu(RMenu:Get('boutique', 'main'), "Véhicules", "https://discord.gg/JFq55Z34nP"))
RMenu.Add('boutique', 'vehiclemenuparam', RageUI.CreateSubMenu(RMenu:Get('boutique', 'vehiclemenu'), "Paramètres", " "))
RMenu.Add('boutique', 'armesmenu', RageUI.CreateSubMenu(RMenu:Get('boutique', 'main'), "Armes", "https://discord.gg/JFq55Z34nP"))
RMenu.Add('boutique', 'moneymenu', RageUI.CreateSubMenu(RMenu:Get('boutique', 'main'), "Argent", "https://discord.gg/JFq55Z34nP"))
